        ...
        <div className="w-4/5 mx-auto max-w-custom">
          ...
          <div className="relative mt-40">
            ...
            <p className="text-2xs text-white-dark font-medium my-8 max-w-[22rem] tablet:text-xs">
              I aint for sale mother fucker and dont even try and touch me. You
              cant afford me baby. What do you mean Calhoun, I thought we was
              meant ot be together. You broke my heart you cold bitch.
            </p>
          </div>
        </div>
      </div>
